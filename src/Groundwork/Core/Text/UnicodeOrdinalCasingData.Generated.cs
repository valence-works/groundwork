...
// See THIRD-PARTY-NOTICES.md in the Groundwork.Core package.
internal static class UnicodeOrdinalCasingData
{
    public const string UnicodeVersion = "16.0.0";
    public const int SupplementarySimpleUppercaseMappingCount = 282;

    public static ReadOnlySpan<int> SupplementarySimpleUppercaseMappings =>
    [
